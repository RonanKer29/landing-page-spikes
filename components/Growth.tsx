...
const Growth = () => {
  ...
  return (
    <div className="flex flex-col items-center justify-center mt-36 space-y-6 text-center">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4 w-[1200px] justify-evenly">
        {statistics.map((statistic, index) => (
          <div
            key={index}
            className="flex flex-col items-center justify-between space-y-2 max-w-[200px] "
          >
            <h1 className="text-6xl font-bold text-dark">
              {statistic.percentage}
            </h1>
            <p className="text-darkGray font-dmsans text-base items-center justify-center">
